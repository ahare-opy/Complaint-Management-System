...
import ModalComplainAgainstDetails from './ModalComplainAgainstDetails';

function CardComplainAgainst({ user, complain, setComplains }) {
      ...
      {showModal && (
        ...
        >
          <Modal.Content scrolling>
            <ModalComplainAgainstDetails user={user} complain={complain} />
          </Modal.Content>
        </Modal>
      )}
    </div>
...
export default CardComplainAgainst;
